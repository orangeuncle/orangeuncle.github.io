...
// Mov3 the stars with mouse pointer
window.addEventListener('mousemove', function(e) {
    mouse.x = e.x;
    mouse.y = e.y;
	
	function strx(){
        var mouseDist = mouse.x - centerX;
        var starDist = (mouseDist/2) * -1;

        console.log("starDistX: " + starDist);
        console.log("MouseDistX: " + mouseDist);
        return starDist;
    }
	function stry(){
        var mouseDist = mouse.y - centerY;
        var starDist = (mouseDist) * -1;
        console.log("starDistY: " + starDist);
        return starDist;
    }
	starX_dir = strx();
	starY_dir = stry();
